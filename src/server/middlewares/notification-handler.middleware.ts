...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order Placed.create': {
    roles: ['business-owner', 'team-member', 'customer-service-representative', 'sales-manager'],
    key: 'order_placed',
    tenantPath: [],
    userPath: [],
  },
  'Support Ticket Created.create': {
    roles: ['business-owner', 'team-member', 'customer-service-representative'],
    key: 'support_ticket_created',
    tenantPath: [],
    userPath: [],
  },
  'Sales Target Updated.update': {
    roles: ['business-owner', 'team-member'],
    key: 'sales_target_updated',
    tenantPath: [],
    userPath: [],
  },
};
